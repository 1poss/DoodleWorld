...
namespace JackUtil {
    ...
    public static class RigidBody2DExtention {
        ...
        public static void MoveInAir(this Rigidbody2D _rig, float _xAxis,float _moveSpeed = 10.5f, float _accelerate = 0.018f, float _decelerate = 0.0032f, float _tentToSpeed = 0) {
